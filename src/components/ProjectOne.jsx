...
export default function ProjectOne() {
    ...
    const images = {
        firstImage: 'images/NailStore-home.png',
        secondImage: 'images/NailStore-shop.png',
        thirdImage: 'images/NailStore-login.png',
        fourthImage: 'images/NailStore-product.png',
    }
    ...
    return (
        <motion.div
            ...
            <div className='mt-3 w-11/12 lg:w-[100%]'>
            ...
            <ul className='flex w-full justify-center'>
                ...
                <li onClick={() => { setImage(images.fourthImage) }} className='w-11/12 m-1 lg:w-[150px]'>
                    <Img
                        source={images.fourthImage}>
                    </Img>
                </li>
            </ul>
        </motion.div>
