export const works = [
    {
        ...
        main: 'Desktop - Registered-Home-Nailstore.png',
        secondary: 'Phone - Registered-Home-Nailstore.png',
    },
    {
        ...
        main: 'mockup-opencuriosity.png',
        secondary: 'mockup-opencuriosity-phone.png',
     },
    // {
    //     title: 'dashboard-in-universe',
    //     color: "#803aed",
    //     header: 'A dashboard to control & manage posts for a blog',
    //     rol: 'Design & Web Development',
    //     description: 'opencuriosity is an educational project to teach science in a more interactive way (inspired by brilliant.org) for all ages and for any level of knowledge. (Project still in design)',
    //     main: 'Dashoboard Home - Desktop.png',
    //     secondary: 'Dashoboard Home - Phone.png',
    // },
]